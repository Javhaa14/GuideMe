...
export const Navigation = () => {
  ...
  const [gprofile, setGprofile] = useState<any>();
  ...
  // useEffect-үүд дарааллаа алдахгүйгээр
  useEffect(() => {
    if (!user?.id) return;
  ...
  const handleGoToProfile = () => {
    if (user.role === 'Guide') {
      ...
      if (!tprofile) {
        ...
        router.push(`/Touristdetail/${user.id}`);
      }
    } else {
      router.push('/');
    }
          ...
          <>
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end" className="w-60">
                ...
                <div className="p-2">
                  {/* Хэрэглэгч Google Translate dropdown-ийг шууд харахгүй тул hidden */}
                  <div id="google_translate_element" className="hidden" />
                  <Select
                    value={language}
