        ...
        <div className="text-center">
          <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
            <DialogTrigger asChild>
              <Button
                size="lg"
                className="w-auto flex items-center justify-center gap-3 px-8 py-4 bg-sky-700 rounded-2xl text-lg font-semibold shadow-lg hover:shadow-xl transform hover:scale-105"
              >
                ...
                <Card className="bg-white border border-gray-200 shadow-lg rounded-2xl mb-6">
                  <CardContent className="p-6">
                    ...
                    <p className="text-sm text-gray-500">
                      Select a status above, then click on calendar dates to
                      apply it.
                    </p>
                  </CardContent>
                </Card>
                  ...
                  <CardContent className="p-6">
                    ...
                    <div className="mt-6 pt-4 border-t border-gray-200">
                      ...
                      <div className="flex gap-4 text-xs">
                        {(
                          Object.keys(statusConfig) as AvailabilityStatus[]
                        ).map((status) => (
