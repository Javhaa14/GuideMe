    ...
    <div className="flex flex-col w-[400px] items-start gap-2">
      ...
      <div className="w-full max-w-sm px-2 py-1 gap-2">
        ...
        <div className="relative">
          ...
          >
            <Slider.Track className="bg-sky-700 relative grow rounded-full h-2 transition-all duration-200">
              <Slider.Range className="absolute bg-sky-700 rounded-full h-full transition-all duration-300" />
            </Slider.Track>
            <Slider.Thumb
              className="block w-5 h-5 bg-white rounded-full border-3 border-sky-700  shadow-lg hover:shadow-xl focus:outline-none focus:ring-3 focus:ring-sky-700  focus:ring-offset-2 transition-all duration-200 hover:scale-110 cursor-grab active:cursor-grabbing"
